...
import Session from '../../database/session/domain/SessionDomain';
    ...
    it('should retrieve sessions by studyId', (done) => {
        ...
        request(app)
            ...
            .then((res) => {
                ...
                expect(sessionsFromApi[0].note).toBe('Testing');
                ...
                expect(sessionsFromApi[1].note).toBe('');
    ...
    it('should retrieve a session by sessionId', (done) => {
        ...
        request(app)
            ...
            .then((res) => {
                ...
                expect(sessionsFromApi.note).toBe('Testing');
    ...
    it('should create a new session', (done) => {
        ...
        request(app)
            ...
            .then((res) => {
                ...
                expect(sessionsFromApi.note).toBe('Nothing special');
